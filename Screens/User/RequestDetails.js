        ...
        <div class="flex h-screen w-full items-center justify-center bg-gray-600">
          <div class="w-80 rounded bg-gray-50 px-6 pt-8 shadow-lg">
            ...
            <div class="flex flex-col gap-3 border-b py-6 text-xs">
              ...
              <p class="flex justify-between">
                <span class="text-zinc-600">Requestor:</span>
            ...
            <div class="flex flex-col gap-3 pb-6 pt-2 text-xs">
              <table class="w-full text-left">
                <thead>
                  <tr class="flex">
                    ...
                    <th class="min-w-[44px] py-2">Subtotal</th>
                  </tr>
                </thead>
                <tbody>
                  <tr class="flex flex-col ">
                    ...
                    <tr class="flex justify-between">
                      ...
                      <td class="min-w-[44px]">₱${requestItem.price.toFixed(2)}</td>
                    </tr>
                    `
                      )
                      .join("")}</td>
              ...
              <div class="py-4 justify-center items-center flex flex-col gap-2">
                <p class="flex gap-2">
                  ...
                  </svg> blessedlandacademy2005@yahoo.com
                </p>
                <p class="flex gap-2">
                  <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 24 24" fill="none">
