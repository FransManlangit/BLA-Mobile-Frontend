  ...
  const searchRequests = (text) => {
    setFilteredRequests(
      requests.filter((request) => {
        ...
        return (
          trackingId.toLowerCase().includes(text.toLowerCase()) ||
        ...
        <View className="p-3">
          ...
          <View className="flex flex-col">
            <View style={styles.dropdownContainer}>
              ...
              >
                <Select.Item label="Approved by Guidance" value="Approved by Guidance" />
                <Select.Item label="Pending" value="Pending" />
                <Select.Item
                  label="Pending Violation"
                  value="Pending Violation"
                />
            ...
            <FlatList
              ...
              renderItem={({ item }) => (
                <View className="space-y-4">
                  ...
                  <View style={styles.requestItem}></View>
                </View>
              )}
