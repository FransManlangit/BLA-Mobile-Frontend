      ...
      >
        <View className="flex flex-row justify-between">
          ...
          <View className="flex-1 justify-center items-start ">
            <Text className="font-semibold text-xs text-center">{item.violationInfo}</Text>
          </View>
          <View className="flex-1 justify-center items-start">
            <View
            ...
            >
              <Text className="text-white font-semibold text-sm text-center  w-20">{item.status}</Text>
            </View>
          </View>
        </View>
      </TouchableOpacity>
...
export default ViolationLogsList;
